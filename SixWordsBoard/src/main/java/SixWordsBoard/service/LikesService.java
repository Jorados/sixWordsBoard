...
import SixWordsBoard.repository.LikesJpaRepository;
...
public class LikesService {
    ...
    //해당 게시글 좋아요 -1하고 좋아요 취소
    public void unlike(Long memberId,Long boardId){
        Board findBoard = boardJpaRepository.findByBoardId(boardId); //글 찾아서
        likesJpaRepository.unlike(memberId, boardId, findBoard); //좋아요 취소하고
        findBoard.minusLikeCount(); //카운트 -1
    }
    ...
    //보드 아이디가 키 ,좋아요 눌렀는지 안눌렀는지 값 가져오기
